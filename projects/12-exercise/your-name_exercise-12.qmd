---
title: "Space"
subtitle: "Exercise 12 --- PMAP 8551/4551, Fall 2026"
...
- You'll need to make a copy of `states_with_regions` that has the states shifted around using `shift_geometry()` ([see the example](https://sneupane2.github.io/dataviz-pmap-8551/example/12-example.html#us-map-with-non-continguous-parts))
...
- You'll need to make a copy of that joined dataset that has the states shifted around using `shift_geometry()` ([see the example](https://sneupane2.github.io/dataviz-pmap-8551/example/12-example.html#us-map-with-non-continguous-parts))
