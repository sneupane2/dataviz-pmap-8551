...
knitr::include_graphics(here::here("files", "img", "unzipping", "unzip-mac.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("files", "img", "unzipping", "inside-zip-windows.png"), error = FALSE)
```
...
```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here::here("files", "img", "unzipping", "temp-wd-windows.png"), error = FALSE)
```
...
```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here::here("files", "img", "unzipping", "extract-windows-1.png"), error = FALSE)
```

Then choose where you want to unzip all the files and click on "Extract"

```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here::here("files", "img", "unzipping", "extract-windows-2.png"), error = FALSE)
```
...
```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here::here("files", "img", "unzipping", "extract-windows-3.png"), error = FALSE)
```
