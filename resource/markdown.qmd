...
2. Choose a citation style based on a CSL file. The default is Chicago author-date, but you can choose from 2,000+ [at this repository](https://www.zotero.org/styles). Download the CSL file, put it in your project folder, and add an entry to the YAML metadata:
...
3. Cite things in your document. [Check the documentation for full details of how to do this](https://quarto.org/docs/authoring/citations.html). Essentially, you use `@citationkey` either inside square brackets (`[]`) or outside of them, depending on how you're using the reference in your text:
