...
.light[PMAP 8551/4551: Data Visualization with R<br>
...
default_point <- GeomPoint$default_aes
default_line <- GeomLine$default_aes
default_area <- GeomArea$default_aes
default_rect <- GeomRect$default_aes
default_density <- GeomDensity$default_aes
default_bar <- GeomBar$default_aes
default_col <- GeomCol$default_aes
default_text <- GeomText$default_aes
```
