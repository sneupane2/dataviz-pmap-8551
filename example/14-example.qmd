...
withr::with_dir(here::here(), {
  ...
  little_women_tagged <- readr::read_csv(
    little_women_path,
...
source(here::here("R", "textdata.R"))
cache_textdata_lexicon("afinn", textdata::lexicon_afinn)
```
