...
# Data Visualization with R <a href='https://sneupane2.github.io/dataviz-pmap-8551/'><img src='files/favicon-512.png' align="right" height="139" /></a>

[PMAP 8551/4551 • Fall 2026](https://sneupane2.github.io/dataviz-pmap-8551/)<br>
[Suresh N. Neupane](https://aysps.gsu.edu/profile/suresh-n-neupane/) • Andrew Young School of Policy Studies • Georgia State University
...
2.  Open `dataviz-pmap-8551.Rproj` to open an [RStudio Project](https://r4ds.hadley.nz/workflow-scripts.html#projects).
...
graph LR
  ...
  subgraph Graph
    ...
    xf28a1645f45aa8c4(["zip_proj_01_exercise"]):::queued --> x949bf61054cdbfad(["all_zipped_projects"]):::queued
    x1bf298835b62c314(["zip_proj_01_mini_project"]):::queued --> x949bf61054cdbfad(["all_zipped_projects"]):::queued
    ...
    x7342a89809a935e4(["zip_proj_02_mini_project"]):::queued --> x949bf61054cdbfad(["all_zipped_projects"]):::queued
    ...
    xbdf49713abeb8eb9(["proj_01_exercise_files"]):::queued --> x5a36d3c47c776555["proj_01_exercise"]:::queued
    xf5bc33eccfd1d2cf(["proj_01_mini_project_files"]):::queued --> x088b77bb63aa0928["proj_01_mini_project"]:::queued
    ...
    xfd82aae16817453f(["proj_02_mini_project_files"]):::queued --> x5095812e4b55b585["proj_02_mini_project"]:::queued
    ...
    x310b1f358ca634ee(["proj_final_project_files"]):::completed --> xe06674a27606ee5f["proj_final_project"]:::queued
    ...
    x527abcc5677dae68(["build_data"]):::queued --> xf28a1645f45aa8c4(["zip_proj_01_exercise"]):::queued
    x5a36d3c47c776555["proj_01_exercise"]:::queued --> xf28a1645f45aa8c4(["zip_proj_01_exercise"]):::queued
    x088b77bb63aa0928["proj_01_mini_project"]:::queued --> x1bf298835b62c314(["zip_proj_01_mini_project"]):::queued
    x527abcc5677dae68(["build_data"]):::queued --> x1bf298835b62c314(["zip_proj_01_mini_project"]):::queued
    ...
    x5095812e4b55b585["proj_02_mini_project"]:::queued --> x7342a89809a935e4(["zip_proj_02_mini_project"]):::queued
    x527abcc5677dae68(["build_data"]):::queued --> x7342a89809a935e4(["zip_proj_02_mini_project"]):::queued
...
This course site and its materials are adapted from [Andrew Heiss’s Data Visualization with R course](https://github.com/andrewheiss/datavizsp26.classes.andrewheiss.com).
