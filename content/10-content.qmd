...
xaringanExtra::embed_xaringan("../slides/10-slides.html",
  ratio = "16:9",
  border = "none",
  margin = "0 auto"
)
...
Access the slides, code, and other materials at the course website at https://sneupane2.github.io/dataviz-pmap-8551/content/10-content/
...
Download the data and see the polished code at https://sneupane2.github.io/dataviz-pmap-8551/example/10-example/
```
