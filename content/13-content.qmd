...
xaringanExtra::embed_xaringan("../slides/13-slides.html",
  ratio = "16:9",
  border = "none",
  margin = "0 auto"
)
...
Access the slides, code, and other materials at the course website at https://sneupane2.github.io/dataviz-pmap-8551/content/13-content/
...
Download the data and see the polished code at https://sneupane2.github.io/dataviz-pmap-8551/example/13-example/
```
