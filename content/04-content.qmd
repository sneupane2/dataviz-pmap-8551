...
xaringanExtra::embed_xaringan("../slides/04-slides.html",
  ratio = "16:9",
  border = "none",
  margin = "0 auto"
)
...
Access the slides, code, and other materials at the course website at https://sneupane2.github.io/dataviz-pmap-8551/content/04-content/
...
Access the data, code, and other materials at https://sneupane2.github.io/dataviz-pmap-8551/example/04-example/
```
