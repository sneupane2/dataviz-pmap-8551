...
knitr::include_graphics(here::here("slides", "img", "02", "example-bitmap.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("slides", "img", "02", "example-vector.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("files", "img", "lesson", "file-types", "atlanta-sign.jpg"), error = FALSE)
```
...
knitr::include_graphics(here::here("files", "img", "lesson", "file-types", "gsu-logo.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("files", "img", "lesson", "file-types", "pie_chart.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("files", "img", "lesson", "file-types", "solo.jpg"), error = FALSE)
```
...
knitr::include_graphics(here::here("files", "img", "lesson", "file-types", "butterflies.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("files", "img", "lesson", "file-types", "atlanta-night.jpg"), error = FALSE)
```
