...
set_up_python <- function() {
  library(reticulate)
  virtualenv_create("dataviz-pmap-8551")
  py_install("cleannlp", envname = "dataviz-pmap-8551")
}
...
tag_little_women <- function(raw_text) {
  ...
  # Use spaCy
  reticulate::use_virtualenv("dataviz-pmap-8551", required = TRUE)
